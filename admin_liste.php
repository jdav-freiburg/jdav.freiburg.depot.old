...
<html>
  ...
  <body>
     ...
     <table align="center"  width="90%" >
         <tr bgcolor="#57b065"><h1> Ausr�stungsliste </h1></tr>
         <tr><h1>Diese aktuelle Ausr�stungsliste sollte in regelm��igen Abst�nden ausgedruckt
                 werden und im Jugend-Depot ausgeh�ngt werden.</h1><h4>
     </table>
     <table align="center"  width="90%" >
                      <?php
                        //suchen der 1. gruppe
