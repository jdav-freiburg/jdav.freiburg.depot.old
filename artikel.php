  ...
  <body>
	<form method='post' action="speichern.php">
		...
		<div class="formHeader">
			<h1> Ausr�stung reservieren </h1>
			<p>Um Ausr�stung f�r den angegebenen Zeitraum zu reservieren, markiere die jeweiligen Ausr�stungsteile in der Spalte "Reservieren"</p>
			Du reservierst Ausr�stung f�r den Zeitraum:
			<h1>von:  <?php echo $datumvon ; ?> bis:  <?php echo $datumbis ; ?></h1>
			<h4>f�r die Ausfahrt :<?php echo "$_POST[ort] ($_POST[hinweis])" ; ?></h4>
			<a href="reservierung.php">Zur�ck um Daten zu �ndern</a>
			<div class="formSubmit">
				<input type=submit value='Ausr�stung reservieren'>
			</div>
	...
	<a href="messages.php">Zur�ck zur Startseite</a>
