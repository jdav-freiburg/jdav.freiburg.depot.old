...
<html>
  ...
  <body>
     ...
     <table align="center"  width="90%" >
         ...
         <tr><h1>Hier kannst du dich kostenlos anmelden, um Ausr�stung reservieren zu k�nnen.
         
                 <h4> Deine Daten werden zuerst durch einen Administrator gepr�ft.
                 Erst nachdem er den Account freigeschaltet hat, kannst du Ausr�stung reservieren.
     </table>
     <table align="center"  width="90%" >
     <form method="post" action="anmeldebestatigung.php">
             ...
             <tr bgcolor=#FFFFFF><br><input name="uschlussel" >
                   ...
                   Gruppe f�r die Ausr�stung verantwortlich ist und dir
                   die Ausr�stung aush�ndigt.
             <br> <br></tr>
