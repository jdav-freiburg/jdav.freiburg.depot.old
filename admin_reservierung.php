 ...
 //hier werden Artikel hinzugef�gt
 ...
 //hier werden ganze Reservierungen gel�scht
...
<html>
  ...
  <body>
     ...
     <table align="center"  width="90%" >
         ...
         <tr><h1>Hier kannst du alle Reservierungen auf einen Blick sehen!<br>
                 Um Sie zu bearbeiten, �ndere den Inhalt der Felder und klicke auf Reservierung aktualisieren!</h1><h4>
       ...
       <?php
          ...
          while($rdaten = mysql_fetch_array($resultat)){
                     echo "<form method=post><tr heigth=20>          </tr><tr bgcolor=#57b065>
                        ...
                        </td><td>Einsatzort: <input name=rziel value=$rdaten[rziel]></tr>
                        ...
                        //hier beginnen die Artikel _________________________________
                                                       ...
                                                       $result=mysql_query($sql);
                                                        ...
                                                        while ($adaten=mysql_fetch_row($result)){    //Ausgabe
                                                         echo"
                                                          ...
                                                          <tr bgcolor=#FFFFFF> <td> $adaten[0]</td><td>$adaten[1]</td><td>$adaten[2] <input type=checkbox name=artikelnummer value=$adaten[0]>L�schen?</td> </tr>
                           ...
                           <tr bgcolor=#80FF80> <td> <h2>Bereits reservierte Artikel</h2> <SELECT >";
                             ...
                             echo  //SELECT bei dem der Artikel reserviert wird
                              "
                            <td> <h4>Neuen Artikel hinzuf�gen
                            (bitte vorher links �berpr�fen ob die Ausr�stung frei ist)
                           ...
                           <tr bgcolor=#80FF80> <td><br> <input type=submit value='Reservierung aktualisieren'></form></td>
                           <td><form method=post>
                           <input type=hidden name=rnr value=$rdaten[rnr]>
                           <input type=hidden name=rloschen value=$rdaten[rnr]>
                           <input type=submit value='Reservierung l�schen'></td><td></td></tr></form>
